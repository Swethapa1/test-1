...
public class EnableDomesticOfflinePaymentTest {
...
//		chromeOptions.addArguments("--no-sandbox");
	...
	@Test
	public void testEnableDomesticOfflinePmt() throws InterruptedException {
		...
		pb.clickPayment();
		Thread.sleep(2000);
		testutils.enableOfflinePayment(RandomStringUtils.randomAlphabetic(12), "domestic");
	}
}
