...
public class EnableInternationalOfflinePaymentTest {
...
//		chromeOptions.addArguments("--no-sandbox");
	...
	@Test
	public void testEnableInternationalOfflinePmt() throws InterruptedException {
		...
		pb.clickPayment();
		Thread.sleep(2000);
		testutils.enableOfflinePayment(RandomStringUtils.randomAlphabetic(12), "international");
	}
}
