...
public class EnableOwnShippingInternationalTest {
...
//		chromeOptions.addArguments("--no-sandbox");
	...
	@Test
	public void testEnableOwnShippingInternational() throws InterruptedException {
		...
		pb.clickShipping();
		Thread.sleep(2000);
		testutils.enableOwnShipping("international");
	}
}
