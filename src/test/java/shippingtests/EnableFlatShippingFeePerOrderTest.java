...
public class EnableFlatShippingFeePerOrderTest {
...
//		chromeOptions.addArguments("--no-sandbox");
	...
	@Test(priority=1)
	public void testEnableFlatShippingFeePerOrder_domestic() throws InterruptedException {
		...
		pb.clickShipping();
		Thread.sleep(2000);
		testutils.enableFlatShippingFeePerOrder("domestic", RandomStringUtils.randomNumeric(3)+".00");
		}
