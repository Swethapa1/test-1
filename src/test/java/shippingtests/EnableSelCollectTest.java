...
public class EnableSelCollectTest {
...
//		chromeOptions.addArguments("--no-sandbox");
	...
	@Test
	public void testEnableSelfCollect() throws InterruptedException {
		...
		pb.clickShipping();
		Thread.sleep(2000);
		testutils.enableSelfCollect(RandomStringUtils.randomAlphabetic(50));
	}
}
