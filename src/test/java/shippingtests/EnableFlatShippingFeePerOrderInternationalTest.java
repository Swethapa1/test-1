...
public class EnableFlatShippingFeePerOrderInternationalTest {
...
//		chromeOptions.addArguments("--no-sandbox");
	...
	@Test(priority=1)
	public void testEnableFlatShippingFeePerOrder_international() throws InterruptedException {
		...
		pb.clickShipping();
		Thread.sleep(2000);
		testutils.enableFlatShippingFeePerOrder("international", RandomStringUtils.randomNumeric(3)+".00");
		}
