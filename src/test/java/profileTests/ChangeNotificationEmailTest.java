...
public class ChangeNotificationEmailTest {
...
//		chromeOptions.addArguments("--no-sandbox");
	...
	@Test
	public void testChangeNotificationEmail() throws InterruptedException {
		testUtils = new TestUtils(driver);
		testUtils.login(properties.get("email"), properties.get("password"), properties.get("url"));
		
		testUtils.changeNotificationEmail(RandomStringUtils.randomAlphanumeric(5)+"@testshop.com");
	}
