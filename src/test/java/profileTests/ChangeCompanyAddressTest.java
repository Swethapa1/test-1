...
public class ChangeCompanyAddressTest {
...
//		chromeOptions.addArguments("--no-sandbox");
	...
	@Test
	public void testChangeCompanyName() throws InterruptedException {
		testUtils = new TestUtils(driver);
		testUtils.login(properties.get("email"), properties.get("password"), properties.get("url"));
		testUtils.changeCompanyAddress(RandomStringUtils.randomAlphabetic(10));
	}
