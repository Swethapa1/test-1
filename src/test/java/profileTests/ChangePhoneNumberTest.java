...
//		chromeOptions.addArguments("--no-sandbox");
	...
	@Test
	public void testChangePhNo() throws InterruptedException {
		testUtils = new TestUtils(driver);
		testUtils.login(properties.get("email"), properties.get("password"), properties.get("url"));
		switch(properties.get("region")) {
			case "in": 
				num=RandomStringUtils.randomNumeric(10);
				break;
				
			case "sg":
				num=RandomStringUtils.randomNumeric(8);
				break;
			...
			case "ae":
				num=RandomStringUtils.randomNumeric(9);
				break;
		}
		testUtils.changePhoneNumber(num);
	}
