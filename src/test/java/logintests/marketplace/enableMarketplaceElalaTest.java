...
public class enableMarketplaceElalaTest {
	...
	@Test
	public void testEnableElala() throws InterruptedException {
		testutils= new TestUtils(driver);
		testutils.login(properties.get("email"), properties.get("password"), properties.get("url"));
		testutils.enableMarketPlace("e-lala", properties.get("region"));
	}
}
