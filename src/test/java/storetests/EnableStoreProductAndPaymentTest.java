...
public class EnableStoreProductAndPaymentTest {
...
//		chromeOptions.addArguments("--no-sandbox");
	...
	@Test
	public void testEnableStore_ProductAndPayment() throws InterruptedException {
		testUtils = new TestUtils(driver);
		testUtils.login(properties.get("email"), properties.get("password"), properties.get("url"));
		testUtils.enableStore("product and payment");
		Thread.sleep(2000);
	}
