...
public class EnableStoreProductPaymentAndShippingTest {
...
//		chromeOptions.addArguments("--no-sandbox");
	...
	@Test
	public void testEnableStore_ProductPaymentAndShipping() throws InterruptedException {
		testUtils = new TestUtils(driver);
		testUtils.login(properties.get("email"), properties.get("password"), properties.get("url"));
		testUtils.enableStore("product,payment and shipping");
		Thread.sleep(2000);
	}
