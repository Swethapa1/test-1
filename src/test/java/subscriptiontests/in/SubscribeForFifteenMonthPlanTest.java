...
public class SubscribeForFifteenMonthPlanTest {
...
//		chromeOptions.addArguments("--no-sandbox");
	...
	@Test
	public void testSubscribeForFifteenMonthPlan_in() throws InterruptedException {
		testUtils = new TestUtils(driver);
		testUtils.login(properties.get("email"), properties.get("password"), properties.get("url"));
		testUtils.enableSubscription(properties.get("region"), "Fifteen");
	}
