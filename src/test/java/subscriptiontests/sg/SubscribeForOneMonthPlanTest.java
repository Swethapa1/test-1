...
public class SubscribeForOneMonthPlanTest {
...
//		chromeOptions.addArguments("--no-sandbox");
	...
	@Test
	public void testSubscribeForOneMonthPlan_sg() throws InterruptedException {
		testUtils = new TestUtils(driver);
		testUtils.login(properties.get("email"), properties.get("password"), properties.get("url"));
		testUtils.enableSubscription(properties.get("region"), "One");
	}
